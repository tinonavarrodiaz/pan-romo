...
mb_http_output('UTF-8');
  ...
  $subject = "Formulario eviado desde el formulario 'Sé Distribuidor' de panaderiaromo.com";
...
try {
    ...
    <h1>Formulario eviado desde el formulario 'Sé Distribuidor' de panaderiaromo.com</h1>
